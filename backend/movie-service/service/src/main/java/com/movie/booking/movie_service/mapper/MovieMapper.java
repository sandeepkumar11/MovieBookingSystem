...
public class MovieMapper {
    ...
    public static MovieResponse toResponse(Movie movie) {
        return new MovieResponse(
                ...
                movie.getLanguages(),
                movie.getDuration(),
                movie.getDirectors()!=null? movie.getDirectors().stream().map(CastMapper::toResponse).collect(Collectors.toList()) : List.of(),
                movie.getProducers()!=null? movie.getProducers().stream().map(CastMapper::toResponse).collect(Collectors.toList()) : List.of(),
                movie.getCast()!=null? movie.getCast().stream().map(CastMapper::toResponse).collect(Collectors.toList()) : List.of(),
